          ...
          <div className="hidden md:flex items-center space-x-8">
            {navItems.map((item, index) => (
              <motion.button
                ...
                className="text-cyber-blue hover:text-primary transition-colors duration-200 font-semibold"
              >
                {item.name}
              </motion.button>
            ))}
                ...
                <div className="flex flex-col space-y-4">
                  {navItems.map((item, index) => (
                    <motion.button
                      ...
                      onClick={() => scrollToSection(item.href)}
                      className="text-left text-cyber-blue hover:text-primary transition-colors duration-200 font-semibold py-2"
                    >
                      {item.name}
                    </motion.button>
                  ))}
