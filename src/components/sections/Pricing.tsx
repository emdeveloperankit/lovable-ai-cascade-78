...
const Pricing = () => {
  ...
  const services = [
    {
      ...
      features: [
        "Handle calls & qualify leads automatically",
    ...
    },
    {
      ...
      features: [
        "Multi-platform integration (Website, WhatsApp, Instagram, Facebook)",
        "Automated sales & customer support",
  ...
  return (
    <section ref={ref} id="pricing" className="py-20 bg-surface overflow-hidden">
        ...
        >
          {services.map((service, index) => (
            <motion.div 
              ...
              className={`cyber-card relative ${service.popular ? 'border-accent mt-6' : ''}`}
            >
              {service.popular && (
                <motion.div
                ...
                >
                  <div className="bg-primary text-primary-foreground px-6 py-2 rounded-full text-sm font-bold flex items-center gap-2 shadow-lg border-2 border-primary-foreground/20">
